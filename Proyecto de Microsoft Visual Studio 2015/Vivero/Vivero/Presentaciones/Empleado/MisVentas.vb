Public Class MisVentas
    ...
    Private Sub btnactualizar_Click(sender As Object, e As EventArgs) Handles btnactualizar.Click
        ...
        objNFactura.cargarGrid_byVendedor(DataGridView_Facturas, user_login.id_usuario)
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        objNFactura.cargarGrid_byFecha(DataGridView_Facturas, user_login.id_usuario, CDate(FechaDesde.Text), CDate(FechaHasta.Text))
        DataGridView_Detalles.Columns.Clear()
    End Sub
